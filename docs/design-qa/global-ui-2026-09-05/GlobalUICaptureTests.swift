...
private enum DesignFixtures {
    static let date = ISO8601DateFormatter().date(from: "2026-09-04T12:30:00Z")!
...
private struct DesignAPI: ForexAPI {
    ...
    func calendarDetail(id: String) async throws -> CalendarDetail {
        try JSONDecoder.api.decode(CalendarDetail.self, from: Data(#"{"source_id":"1","title_en":"Non-Farm Employment Change","currency":"USD","currency_name":"US dollar","impact":"high","actual":"142K","forecast":"165K","previous":"89K","actual_state":"worse","previous_state":"better","source_name":"Sample release","frequency":"Monthly","measures":"Change in the number of employed people during the previous month, excluding the farming industry.","history":[{"release_date_text":"Aug 7, 2026","actual":"89K","forecast":"100K","previous":"104K","actual_state":"worse"}],"related_stories":[],"updated_at":"2026-09-04T12:30:00Z"}"#.utf8))
    }
    func newsV2Detail(id: String) async throws -> NewsArticleDetail {
        let text = #"{"source_id":"1","ff_url":"https://www.forexfactory.com/news/1","title":{"en":"Markets await the next inflation report","zh_hans":"保留翻译"},"teaser":{"en":"Investors are watching key economic data for signs of the path of interest rates."},"source_name":"Sample news","published_at":"2026-09-04T12:30:00Z","comment_count":12,"detail_state":"complete","is_excerpt":true,"categories":["latest"],"feeds":[],"segments":[{"id":1,"stable_key":"p1","position":0,"type":"article","text":{"en":"Investors are turning their attention to the next inflation report after a mixed set of employment figures. The details of the release may prove more informative than the headline number alone."},"is_excerpt":false,"media":[],"links":[]},{"id":2,"stable_key":"q1","position":1,"type":"quote","text":{"en":"The direction of travel matters more than a single month of data."},"is_excerpt":false,"media":[],"links":[]},{"id":3,"stable_key":"p2","position":2,"type":"article","text":{"en":"Wage growth, participation and revisions will remain in focus. Traders are also watching how the latest figures fit alongside broader measures of demand and price pressure."},"is_excerpt":false,"media":[],"links":[]}],"comment_count_collected":3,"comments_complete":false,"generated_at":"2026-09-04T12:30:00Z"}"#
